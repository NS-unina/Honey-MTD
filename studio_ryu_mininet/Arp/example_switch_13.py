...
class ExampleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        if arp_pkt:
            if arp_pkt.opcode == arp.ARP_REPLY and arp_pkt.dst_ip == '10.0.1.10' and arp_pkt.src_ip == '10.0.1.11':
                        print(arp_pkt)
                        out_port = 1
                        actions = [parser.OFPActionSetField(arp_sha='00:00:00:00:00:09'),
                            parser.OFPActionSetField(arp_spa='10.0.1.200'),
                            parser.OFPActionOutput(out_port)]
                        
                        #match = datapath.ofproto_parser.OFPMatch(eth_type=0x806, arp_op = 2, arp_tpa='10.0.1.10', arp_spa='10.0.1.11')
